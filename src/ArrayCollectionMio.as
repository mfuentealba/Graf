...
package
{
	...
	public class ArrayCollectionMio extends ListCollectionViewMia implements IExternalizable
	{
		...
		public var objChange:Object = {};
		
		public function ArrayCollectionMio(source:Array = null)
		{
			super();
		...
		{
			if (list && (list is ArrayListMia))
			{
				return ArrayListMia(list).source;
			}
			return null;
		}
		...
		public function setItemAtsource(item:Object, index:int):Object
		{
			// TODO Auto Generated method stub
			return super.setItemAt2(item, index, source);
		}
