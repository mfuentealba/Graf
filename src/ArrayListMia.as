package 
{
	 ...
	 */
	public class ArrayListMia extends EventDispatcher
		implements IList, IExternalizable, IPropertyChangeNotifier
	{
		 ...
		 *  @productversion Flex 3
		 */
		public function ArrayListMia(source:Array = null)
		{
			super();
		...
		public function setItemAt2(item:Object, index:int):Object
		{
			if (index < 0 || index >= length) 
			{
				var message:String = resourceManager.getString(
